...
var EchartsBarsTornados = function() {
    ...
    var _barsTornadosExamples = function() {
        ...
        var bars_staggered_element = document.getElementById('bars_staggered');
        ...
        //TEST
        // Tornado with staggered labels
        if (bars_staggered_element) {

            // Initialize chart
            var bars_tornado_staggered = echarts.init(bars_staggered_element);
        ...
        var triggerChartResize = function() {
            ...
            bars_staggered_element && bars_tornado_staggered.resize();
        };
